...
static Task * CreateCopyTask(CitusCopyDestReceiver *copyDest, ShardData *shardData, int taskId);
...
static Task *
CreateCopyTask(CitusCopyDestReceiver *copyDest, ShardData *shardData, int taskId)
{
	Task *task = NULL;
